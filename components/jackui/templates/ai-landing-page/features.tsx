    ...
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 p-8 sm:p-10 items-center h-full w-full">
      ...
      <div className="lg:col-span-7 relative w-full h-full flex items-center justify-center">
        <div className="relative w-full rounded-[20px] p-[2px] group">
          ...
          {/* The Image Container */}
          <div className="relative w-full rounded-[18px] overflow-hidden bg-white dark:bg-zinc-950 z-10 shadow-lg">
            <img
              src={featureImg}
            ...
            <div className="absolute inset-0 ring-1 ring-inset ring-black/5 dark:ring-white/5 rounded-[18px] pointer-events-none z-20"></div>
          </div>
        </div>
      </div>
    </div>
...
function OrchestrationPipeline() {
  ...
  return (
    <div className="flex flex-col h-full w-full p-6 sm:p-8 justify-between space-y-6">
      ...
      <div className="relative flex-1 min-h-[190px] w-full rounded-xl border border-zinc-200/60 dark:border-zinc-800/80 bg-zinc-50/50 dark:bg-zinc-900/20 overflow-hidden flex items-center justify-center p-4">
        {/* Lines Background in Graph container */}
        <div 
          className="absolute inset-0 bg-[size:100%_0.5rem] text-zinc-200/30 dark:text-zinc-850/15 z-0" 
          style={{
  ...
  const defaultFeatures: FeatureItem[] = [
    {
      ...
      title: "",
      description: "",
      className: "md:col-span-3 bg-white/70 dark:bg-zinc-900/30 border border-zinc-200/80 dark:border-zinc-800/80 p-0 overflow-hidden",
    ...
    },
    {
      ...
      title: "",
      description: "",
      className: "md:col-span-1 bg-white/70 dark:bg-zinc-900/30 border border-zinc-200/80 dark:border-zinc-800/80 p-0 overflow-hidden",
    ...
    },
    {
      ...
      title: "",
      description: "",
      className: "md:col-span-2 bg-white/70 dark:bg-zinc-900/30 border border-zinc-200/80 dark:border-zinc-800/80 p-0 overflow-hidden",
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
          {items.map((feature, index) => (
            <motion.div
              ...
              className={cn(
                "group relative flex flex-col justify-start overflow-hidden rounded-[2rem] bg-white/70 dark:bg-zinc-900/30 backdrop-blur-xl border border-zinc-200/80 dark:border-zinc-800/80 shadow-[0_8px_30px_rgb(0,0,0,0.02)] transition-all duration-500 hover:shadow-[0_12px_40px_rgb(0,0,0,0.06)]",
                feature.className
              )}
            >
              {/* Inner subtle glare */}
