    ...
    <div className="relative w-full">
      <nav className="relative z-50 flex items-center justify-between px-6 sm:px-10 py-3 w-full">
        ...
        <div className="flex items-center gap-3 cursor-pointer group">
          ...
          <span className="font-heading font-bold text-lg tracking-tight text-zinc-900 group-hover:text-purple-600 transition-colors">
            {logoText}
          </span>
        </div>
